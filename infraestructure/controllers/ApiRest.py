...
sys.path.insert(0, r'C:\Users\Anel\Downloads\ProductosAPI')

from flask import Flask, request, jsonify
from infraestructure.adapters.ProductRepositoryAdapter import ProductRepositoryAdapter
from domain.models.ProductModel import ProductModel
from domain.uses_cases.ProductUseCase import ProductUseCase
